    ...
    <div class="rounded-xl border border-border bg-surface p-6 sm:p-8 space-y-6 max-w-3xl">
        ...
        <div>
            <div class="flex items-center justify-between mb-1">
                ...
                {{-- <span class="text-xs px-2 py-0.5 rounded bg-surface text-primary font-medium">Umumnya: Kepala Desa / Lurah</span> --}}
            </div>
        ...
        <div>
            <div class="flex items-center justify-between mb-1">
                ...
                {{-- <span class="text-xs px-2 py-0.5 rounded bg-surface text-warning font-medium">Umumnya: Sekretaris Desa</span> --}}
            </div>
            <p class="text-xs text-muted mb-2 leading-relaxed">
        ...
        <div>
            <div class="flex items-center justify-between mb-1">
                ...
                {{-- <span class="text-xs px-2 py-0.5 rounded bg-surface text-info font-medium">Umumnya: Kaur / Kasi / Tim Teknis</span> --}}
            </div>
            <p class="text-xs text-muted mb-2 leading-relaxed">
